...
* (Scriptnya Nfq cuy).
*/
const BotName = 'Vector+V2 Bot'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/fest.pain'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/6285894761296'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung jaringan'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/DFElcvgowUf3Lx3a9bu5rZ'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://youtube.com/channel/UC5AfwvSxWrhMlEnuiM52hag'; // OFFICIAL YT LU
const grupch3 = 'https://chat.whatsapp.com/DFElcvgowUf3Lx3a9bu5rZ'; // OFFICIAL GRUP LU 3
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] TINGGAL SCAN :@Ivector`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ivector`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @ivector`)
})
...
conn.sendMessage(id, 'Owner Ivector+V2 Bot : wa.me/+6285894761296' ,MessageType.text);
}
else if (text == 'bot'){
